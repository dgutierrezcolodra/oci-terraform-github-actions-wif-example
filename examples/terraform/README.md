...
The examples need Terraform `>= 1.5.0` and OCI provider `>= 8.26.0, < 9.0.0`.
The lockfiles select provider 8.26.0.

## Examples

- [standard](./standard/README.md): checks WIF and can create and remove one
  private bucket.
...
`OCI_REGION`, and `COMPARTMENT_ID`. Read [SETUP.md](../../SETUP.md) for the OCI
trust and IAM policy. The trust must match
